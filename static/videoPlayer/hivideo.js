...
(function(global, factory){
        ...
        ["fullscreenchange", "webkitfullscreenchange", "mozfullscreenchange", "MSFullscreenChange"].forEach(function(eventType){
            ...
            document.addEventListener(eventType, function(event){
                ...
                if(self.isFullScreen()){
                    ...
                    if(isRotate && !hivideo.hasClass(self.videoParent, "hi-video-rotate90")){
                        hivideo.addClass(self.videoParent, "hi-video-rotate90");
                    }
                    self.videoParent.style.height = cltHeight + "px";
                    self.videoParent.style.width = cltWidth + "px";
                }else{
                    if(isRotate) self.videoParent.className = self.videoParent.className.replace("hi-video-rotate90", "").trim();
    ...
    hivideo.prototype.bindAutoHideControlsEvent = function(){
        ...
        var showOrHideControls = function(isShow){
            isShow ? hivideo.removeClass(self.videoBar, "hi-video-none") : hivideo.addClass(self.videoBar, "hi-video-none");
        };
